      ...
      <View style={styles.parent}>
        ...
        <TouchableOpacity activeOpacity={0.8} onPress={this.props.onClickFunction} style={styles.category_View}>
                  ...
                  <View style={{flexDirection:'row' ,justifyContent:'center' ,marginLeft:20 , marginRight:20 }}>
                                  ...
                                  <Text style={{left:0 , position:'absolute'}}>{this.props.item.fromstop} </Text>
        ...
        <View style={{ height: this.state.layout_Height, overflow: 'hidden' }}>
          ...
          {
            this.props.item.fromstop.map((item, key) => (

              <TouchableOpacity key={key} style={styles.sub_Category_Text} onPress={this.show_Selected_Category.bind(this, item.fromstop)}>
                    ...
                    <View >
                                <View style={{flexDirection:'row' , marginLeft:10 , marginTop:10}}>
                                          ...
                                          <View style={{flexDirection:'row' ,marginTop:10}}>
                                                ...
                                                <Text style={{marginRight:30, right:0 , position:'absolute'}}>PKR 150.00</Text>
                                          </View>
...
export default class bookinghistory extends Component {
  ...
  constructor() {
    ...
    const array = [
      ...
      {
        category_Name: "Karachi", sub_Category: [{ id: 1, name: 'Mi' },]
      },
  ...
  componentWillMount(){
    ...
    this.get_previous_bookings(46)
  }



  previous_booking_call(sid){
    const baseUrl = "https://hitsofficialpk.com/sitgo/booking/previousbookings?";
   const param = `userid=${sid}`;
                            ...
                            <View style={{ flexDirection: 'row' , backgroundColor:'#ffffff',height:60 }}>
                                      <TouchableOpacity 
                                        ...
                                        <View style={{flexDirection:'column' , marginLeft:20}}>
                                            ...
                                            <Text style={{fontSize:25 , marginTop:10 , fontWeight:'bold'}}>Bookings History</Text>
        ...
        <ScrollView>
          {
            this.state.AccordionData.map((item, key) =>
              (
                <Expandable_ListView key={item.fromstop} onClickFunction={this.update_Layout.bind(this, key)} item={item} />
              ))
          }
        </ScrollView>
