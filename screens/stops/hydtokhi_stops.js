...
export default class hydtokhi_stops extends React.Component {
    ...
    constructor(props){
      ...
      gotoSelectSeatscreen = async () =>{
          if(this.state.fromid == 0 || this.state.fromid == null){
            alert("Please select stops(from)")
          }
          else if(this.state.toid == 0 || this.state.toid == null){
            alert("Please select stops(To)")
          }
          else{
            this.props.navigation.navigate('list_of_stop_buses' ,{
            ...
            <View style={styles.parent}>  
              <View style={styles.statusBarBackground}></View>
                    ...
                    <StatusBar barStyle={'dark-content'} backgroundColor ={'#FFFFFF'} translucent={true} /> 
                                ...
                                <View style={{ flexDirection: 'row', backgroundColor:'#ffffff' ,height:60 , marginTop:20 }}>
                                                        <TouchableOpacity 
               ...
               <View style={{flexDirection:'row'}}>
                      ...
                      {this.state.fontLoaded ? ( <Text style={{fontSize:10 , marginRight:20 , right:0 , position:'absolute',fontFamily:'opreg' , margin:10,textAlign:'right'}}> {i18n.t('from')}</Text>) : null }
               </View>
                        ...
                        {this.state.nostops && <Text style={{alignSelf:'center' , fontSize:20 , marginTop:20}}>{i18n.t('nostopfound')}</Text>}
                   ...
                   {this.state.fontLoaded ? (    <Text style={{fontSize:10 , right:0 , position:'absolute', fontFamily:'opreg' , margin:10,textAlign:'right'}}>{i18n.t('to')}</Text> ) : null }
                 </View>
