                ...
                <StatusBar hidden={false} />
                        ...
                        <View style={{ flexDirection: 'row' , backgroundColor:'#ffffff' ,height:60}}>
                                        ...
                                        <View style={{flexDirection:'column' , marginLeft:20}}>
                                            <Text style={{fontSize:15}}>Book Your Seat</Text>
                                            <Text  style={{fontSize:20 , fontWeight:'500'}}>Where do you want to sit?</Text>
                                        </View>
                              </View>
...
<View style={{flexDirection:'row' , padding:5 , left:0 , position:'absolute'}}>
      ...
      <View style={{flexDirection:'row' , padding:5 , right:0 , position:'absolute'}}>
                    ...
                    <Checkbox size={30}
                        ...
                        <Text style={styles.selectedItemsButton_Text}>Show Selected Seats</Text>
                
                        </TouchableHighlight>
                    
                        <View style={{flexDirection:'row' , alignSelf:'center' , marginTop:10 }}>
                                    <Text style={{fontSize:20 , marginRight:5, color: "#103056",}}>{this.state.select}</Text>
                                    <Text style={{ fontSize: 20, color: "#103056",  }}>{this.state.selectedItems} </Text>
